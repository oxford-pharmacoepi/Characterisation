db_name<- unique(data[[1]]$cdm_name) 

background_md <- glue::glue("
# Characterisation

This Shiny app presents the results of a characterisation done with the R package `OmopSketch` conducted on the database {db_name}.
