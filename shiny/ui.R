            ...
            bslib::layout_sidebar(
              sidebar = bslib::sidebar(
                ...
                shinyWidgets::pickerInput(
                  ...
                  selected = NULL,
                  multiple = FALSE,
                  choices = c("barplot", "densityplot","scatterplot","boxplot"),
                  options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3")
                ),
                shinyWidgets::pickerInput(
                            ...
                            bslib::layout_sidebar(
                              sidebar = bslib::sidebar(
                                shinyWidgets::pickerInput(
                                  ...
                                  label = "Columns",
                                  choices = c("cdm_name", "omop_table", "age_group", "sex", "time_interval", "variable_name", "estimate_name", "source_concept_id", "source_concept_name"),
                            ...
                            bslib::layout_sidebar(
                              sidebar = bslib::sidebar(
                                shinyWidgets::pickerInput(
                                  ...
                                  selected = "overall",
                                  multiple = FALSE,
                                  choices = c("overall", "standard", "source", "missing source", "missing_standard"),
                                  options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3")
                                ),
                                position = "right"
                              ),
                              reactable::reactableOutput("summarise_concept_id_counts_gt_0") |>
                                shinycssloaders::withSpinner()
                            )
                          )
                        )
